        ...
        <div class="container">
            ...
            <div class="main">
                <div class="content">
                    ...
                    <c:if test="${sessionScope.account.isTeacher}">
                        <c:if test="${msg ne ''}">
                        ...
                        <form class="bottom-content" action="create-ques" method="post">
                            <table>
                                <tr>
                                    <td class="tdlabel">
                                        Question:
                    ...
                    <c:if test="${!sessionScope.account.isTeacher|| sessionScope.account==null}">
                        For teacher only!
                    </c:if>
